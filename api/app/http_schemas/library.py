...
section kinds. Type-aware data validation lives in ``app.document_schema`` (the AST
...
from app.document_schema.models import LibraryEntryKindStr, SectionInstance
...
# Tuple form for membership checks (mirrors the Literal in app.document_schema.models).
