...
class TailoringSession(Base):
    ...
    # The source document is optional: protocol v5 can compose a CV from the
    ...
    protocol_version: Mapped[int] = mapped_column(Integer, nullable=False, default=5, server_default="5")
