...
def test_none_spacing_maps_to_zero_vars():
    model = resolve(_document(), HTMLDocumentRenderer(), _manifest("none"), Customizations())
    assert model.css_vars["--spacing-section"] == "0px"
    assert model.css_vars["--spacing-subsection"] == "0px"
