...
ID: TASK-01M129QBNK54QF2Y9PV8WDKN7V
TYPE: task
STATUS: PROPOSED
SUMMARY: TEMPLATE_GUIDE.md describes the old layout_template pipeline, not the manifest-driven
  system
PRIORITY: null
SEVERITY: null
EFFORT: null
...
<!-- Migrated from DOC-01KYZ1XGE9FSXGDWY3T3SZHKDT during the schema-4 cutover. -->
