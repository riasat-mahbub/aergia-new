...
ID: TASK-01M129QBNK54QF2Y9PV8WDKNEE
TYPE: task
STATUS: DONE
SUMMARY: Delete TemplateWizard, TemplateCreatorPage, BaseTemplateCard, TemplateLayoutView,
  userTemplateStore and their tests.
PRIORITY: High
SEVERITY: null
EFFORT: S
OWNER: riasat
...
<!-- Migrated from TASK-01KZPHASE6STEP1-DELETE during the schema-4 cutover. -->
