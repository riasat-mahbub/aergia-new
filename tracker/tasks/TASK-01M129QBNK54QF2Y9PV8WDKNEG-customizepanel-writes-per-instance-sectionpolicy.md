...
ID: TASK-01M129QBNK54QF2Y9PV8WDKNEG
TYPE: task
STATUS: PROPOSED
SUMMARY: Frontend test asserts the customize panel writes per-instance policy overrides
  through the wire.
PRIORITY: High
SEVERITY: null
EFFORT: S
...
<!-- Migrated from TASK-01KZPHASE6STEP2-PANEL during the schema-4 cutover. -->
