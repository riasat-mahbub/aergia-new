...
ID: TASK-01M225JTBDSM6S7HE9EA9S1Q4B
TYPE: task
STATUS: DONE
PRIORITY: Medium
SEVERITY: null
...
RELATIONS:
  supersedes:
  - TASK-01M224MYNZ9RM7XZX5JH1A6VJB
AFFECTS:
  files:
...
CREATED_BY: null
UPDATED_BY: null
CREATED_AT: '2026-09-09T04:07:27.341958+00:00'
UPDATED_AT: '2026-09-09T04:07:27.341958+00:00'
---

# Add a canonical renderer facade and centralize HTML target values without changing output semantics

## Background

Introduce a canonical structural render facade and centralize current HTML
token/value mappings without changing renderer behavior. Migrate preview,
HTML, and PDF callers; defer cascade and capability semantics to follow-up
work.
