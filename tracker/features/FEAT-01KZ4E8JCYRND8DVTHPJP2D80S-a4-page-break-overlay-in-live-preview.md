...
ID: FEAT-01KZ4E8JCYRND8DVTHPJP2D80S
TYPE: feature
STATUS: DONE
SUMMARY: 'A4 page-break rules drawn across the live preview iframe so the user can see where the PDF will cut'
PRIORITY: Medium
SEVERITY: null
EFFORT: S
OWNER: null
...
RELATIONS:
  related:
  - FEAT-01KYZ1HCE56JWXA4B21Q3DFANT
AFFECTS:
  files:
