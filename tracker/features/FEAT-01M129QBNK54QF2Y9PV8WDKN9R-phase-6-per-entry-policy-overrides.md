...
ID: FEAT-01M129QBNK54QF2Y9PV8WDKN9R
TYPE: feature
STATUS: IN_PROGRESS
SUMMARY: Per-instance SectionPolicy overrides — two instances of the same section
  type render differently.
PRIORITY: High
SEVERITY: null
EFFORT: S
OWNER: riasat
...
<!-- Migrated from FEAT-01KZPHASE6STEP2 during the schema-4 cutover. -->
