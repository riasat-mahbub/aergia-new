...
ID: FEAT-01KZPHASE6STEP3
TYPE: feature
STATUS: IN_PROGRESS
SUMMARY: 'Drag-drop zone authoring — the customize tab lets users split, resize, create, and delete zones via the layout editor.'
PRIORITY: High
SEVERITY: null
EFFORT: M
OWNER: riasat
...
RELATIONS:
  ...
  supersedes:
    - FEAT-01KZPHASE6STEP2-phase-6-per-entry-policy-overrides
AFFECTS:
  files:
