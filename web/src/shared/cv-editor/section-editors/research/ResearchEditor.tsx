...
import type { ResearchEntry } from "@/shared/cv/sectionData";
...
export default function ResearchEditor({ data = [], onChange, actions, mode = "section" }: Props) {
  ...
  return (
    <div className="space-y-4">
      <SortableAccordionList
        ...
        renderActions={(entry) => renderEntryActionFor(actions, "research", entry, entry.title)}
