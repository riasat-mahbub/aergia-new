...
interface SortableAccordionListProps<T extends { id: string }> {
  entries: T[];
  onRemove: (index: number) => void;
  onMove: (from: number, to: number) => void;
  getTitle: (entry: T) => string;
  /** Host-provided header action; the list itself stays feature agnostic. */
...
export default function SortableAccordionList<T extends { id: string }>({
  entries,
  onRemove,
  onMove,
  getTitle,
            ...
            {safeEntries.map((entry, i) => (
              ...
              >
                <SortableItem
                  ...
                  onRemove={onRemove}
                  getTitle={getTitle}
                  actions={renderActions ? renderActions(entry) : undefined}
                >
                  {children(entry, i)}
                </SortableItem>
              </motion.div>
