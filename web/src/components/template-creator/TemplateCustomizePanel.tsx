...
export default function TemplateCustomizePanel({
  ...
  const updateColors = (key: string, value: string) => {
    onCustomizationsChange({ ...customizations, colors: { ...colors, [key]: value } });
  };
  const updateFonts = (key: string, value: string) => {
    onCustomizationsChange({ ...customizations, fonts: { ...fonts, [key]: value } });
  };
  const updateSpacing = (key: string, value: string) => {
    onCustomizationsChange({ ...customizations, spacing: { ...spacing, [key]: value } });
  };
