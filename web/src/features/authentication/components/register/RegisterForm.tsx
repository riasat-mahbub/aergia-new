...
import { registerSchema, type RegisterFormData } from "@/features/authentication/domain/validators";
import { useAuthStore } from "@/features/authentication/state/authStore";
import { getRegistrationConfig } from "@/features/authentication/api/auth";
import type { RegistrationConfig } from "@/features/authentication/types";
